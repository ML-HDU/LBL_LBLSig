from my_loss_function.LBL import *
...
class LBL_DSLeNet(LBL):
    ...
    def pretrain(self, train_dataset, AE_optimizer_parameters: My_Optimizer_Parameters):
        ...
        self.AE_optimizer_parameters = AE_optimizer_parameters  # 包含优化器的一些参数
    ...
    def run_with_optimal_parameters(self, save_name_results, train_dataset, test_dataset, number_of_repeats,
        ...
        optimal_mu, optimal_warm_up_n_epochs = \
        ...
        for k in range(number_of_repeats):
            ...
            self.train(train_dataset, optimal_optimizer_parameters, optimal_mu, optimal_warm_up_n_epochs)
    ...
    def my_loadmat_for_optimal_results(self, mat_path):
        ...
        return optimal_testing_accuracy, optimal_ave_testing_accuracy, \
               optimal_AE_optimizer_parameters, optimal_optimizer_parameters, optimal_mu, optimal_warm_up_n_epochs
...
class LBL_MLP(LBL):
    ...
    def my_loadmat_for_optimal_results(self, mat_path):
        ...
        return optimal_testing_accuracy, optimal_ave_testing_accuracy, \
               optimal_optimizer_parameters, optimal_number_of_hidden_neurons, optimal_mu, optimal_warm_up_n_epochs
...
class LBL_OCITN(LBL):
    ...
    def my_loadmat_for_optimal_results(self, mat_path):
        ...
        return optimal_testing_accuracy, optimal_ave_testing_accuracy, \
               optimal_optimizer_parameters, optimal_mu, optimal_warm_up_n_epochs
